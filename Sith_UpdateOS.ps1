...
# Start logging
Start-Transcript "C:\Windows\Temp\Logs\UpdateOS\UpdateOS.log"
...
$GETUPDATES = Get-WindowsUpdate -AcceptAll -WindowsUpdate
...
{    
    ...
    Set-ItemProperty -Path $VersionLocation -Name "UpdateOS" -Value $version
}
catch
{
    Stop-Transcript

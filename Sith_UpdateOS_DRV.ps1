...
# Start logging
Start-Transcript "C:\Windows\Temp\Logs\UpdateOS\UpdateOS_DRV.log"
...
$GETUPDATES = Get-WindowsUpdate -AcceptAll -WindowsUpdate -UpdateType Driver
...
{    
    ...
    Set-ItemProperty -Path $VersionLocation -Name "Driver" -Value $version
}
catch
{
    Stop-Transcript

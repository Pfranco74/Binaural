$scriptversion = '20241113'
cls
Remove-Variable * -ErrorAction SilentlyContinue
$AllApp = $null
$LogFile = 'C:\log\AppsTime.log'
$count = 1
$datePattern = 'date="(.*?)"'
$timePattern = 'time="(.*?)"'
    ...
    if (($endappOK -eq $true))
    {
            ...
            if (($App -ne $null) -and ($takethat -notlike "*-*") -and ($PreviousApp -notlike $App)  -and ($takethat -notlike "*00:00:0*"))
            {
                if ($portalapp -ne $true)
                {
                    ...
                    [TimeSpan]$Apptime = $takethat.Replace("Total Time: ","") 

                    $totaltimeapps += "'" + $Apptime + "',"
                    $apptt = $takethat.Replace("Total Time: ","") + ";" + $App
                    Out-File -FilePath $LogFile -InputObject $apptt -Append
...
Else
{
    ...
    foreach ($time in $totaltimeapps.Split(","))
    {
        if ($time.Length -ne 0)
        {
            $aamvtime += [timespan]$time.Replace("'","")
        }
    }

    write-host "Total Time: $aamvtime"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjmXdvngJ4OgjSte62CbcJcnh
# grKgghl6MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFLI19VQRPvXH5SV
# 1cWpFOmL/AgzMA0GCSqGSIb3DQEBAQUABIIBAE3qwyVtkJp5GYp4t8WiXScsS8WN
# bM4BWh9jc+/Bk8FFVZsGPI1JYffsIs1t74Ml74bP5FTnkAWzI1mGbn+GU7yyCxQ6
# Qwo16HoyDqs7zBRCp31qCd+3MFnWxJ8ORP+xOC6vr2t3a4N0KD9SGEItwWdWW4Yp
# V+wxZchLc+5PXQHmlvkbkGp8/KiuSpNE3QYyM5TgD9PCw7REaWJsdTBO8XjfCq37
# oCYZXskwCyG1vZbVmjrIqBGA/z/jbKijc3UUyKqq8s8egKvpdG+fYHI/ucK+8VdP
# aLVBYEKpchJvmtoycnVupZ6Z+fLVdQbK+s8ZKvBH/+1fEziDGZ2psOjCgvyhggMg
...
# BgkqhkiG9w0BCQUxDxcNMjQxMTEzMjIxNTQ1WjAvBgkqhkiG9w0BCQQxIgQgMsm0
# Ay2Vz/V+mH/fD/5yYg5kFZwmoKNhJXYnT0bjyTkwDQYJKoZIhvcNAQEBBQAEggIA
# sxXhQGvEEGb90O2czKx9NwbrKYSkViN5KGW2PKNAMdS3LqckmUSisGl94nEDet5H
# XxsNLpmql6nOB4FSbMghDBmjw76cgWtxwqp9n0fu6IYYzxmN3avHv4buYY/C9VIb
# C31jtai67gztCUuH00ffCsceEn/2nXjWEns6rvnJWA4iYGMICam/An7PIcHftvNy
# gGxXXNFKExztT9ucTg2Sc4zICJmu40Rp+P8lytH+KH8JMmV8y7GXOu0P8GqcESHu
# XKT68eLx+nHHtRdaodbG9XNyWSMP5/2u6sxuqrDNDAulTEkzYArU0b3yDja5msYo
# J1k2G7XJ9IrFiOUA8gevjEmuPOPjPTfoXWuclmHZG0b8omr1H57zIzuQUJKYzMAO
# avfKfzwifObz6QxN+uiS5gkJGCeXJCoF2qrxpnYyWMGP6HM3tre3mpRZKV37X13n
# ViTnfWdSarDL+hcuTWVVdSxaQM3lBQkRv6DqdJRhdnJXDbKK7CNfTDJLjhVcBbpn
# H58AXFrlUlRaXQr1Py39FM13NfnpC0gEK2nCLQlxIAj6l7RthheCzM64shvYddPV
# urKcPgf3a/ImsakPD02e34rLqrGh5pAOVMIWLlXYgh9UgzkUg5toMfulvumIpEtE
# D3KMHyRjuvL0it+ynwu0/N4Sle8MOASw0KqokP4Wgzg=
